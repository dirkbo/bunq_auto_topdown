...
class ShareLib(object):
    ...
    _OPTION_FROM_ACCOUNT = '--topdown_from_account'
    _OPTION_TO_ACCOUNT = '--topdown_to_account'
    ...
    def parse_all_option(cls):
        ...
        parser.add_argument(cls._OPTION_FROM_ACCOUNT)
        parser.add_argument(cls._OPTION_TO_ACCOUNT)
